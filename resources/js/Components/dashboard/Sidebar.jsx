    ...
    <aside className="w-56 min-h-screen flex flex-col"
          ...
          return (
            <motion.div key={item.href} initial={{ opacity: 0, x: -6 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.06 + i * 0.04 }}>
              <Link href={item.href}
                ...
                style={active
                  ? { background: 'rgba(255,255,255,0.04)', borderLeft: `1px solid ${TEXT}`, paddingLeft: 11, color: TEXT }
      ...
      <div className="p-3 border-t" style={{ borderColor: BORDER }}>
        <button onClick={logout}
          ...
          onMouseEnter={e => { e.currentTarget.style.color = '#e87070'; e.currentTarget.style.borderLeftColor = 'rgba(204,34,34,0.4)'; }}
