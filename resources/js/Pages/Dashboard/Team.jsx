            ...
            {skills.map((sk,i) => (
                <div key={i} className="flex gap-2 items-center">
                    <input value={sk.name} onChange={e=>update(i,'name',e.target.value)} placeholder="Compétence"
                        className="flex-1 bg-[#091e30] border border-[#00a8ff]/15 rounded-lg px-3 py-1.5 text-white text-sm font-mono outline-none focus:border-[#00a8ff]/40 placeholder-white/10" />
                    <input value={sk.category} onChange={e=>update(i,'category',e.target.value)} placeholder="Catégorie" style={{width:100}}
                        className="bg-[#091e30] border border-[#00a8ff]/15 rounded-lg px-3 py-1.5 text-white text-sm font-mono outline-none focus:border-[#00a8ff]/40 placeholder-white/10" />
                    <input type="number" min={0} max={100} value={sk.level} onChange={e=>update(i,'level',e.target.value)} style={{width:60}}
                        className="bg-[#091e30] border border-[#00a8ff]/15 rounded-lg px-2 py-1.5 text-white text-sm font-mono outline-none focus:border-[#00a8ff]/40 text-center" />
...
function MemberEditor({ member }) {
    ...
    return (
        <div className="relative border rounded-xl overflow-hidden bg-[#0d2540]/90 backdrop-blur-sm"
...
function AddMemberForm({ onClose }) {
    ...
    return (
        <div className="relative border border-[#00a8ff]/20 rounded-xl bg-[#0d2540]/90 p-6 mb-6">
            <Scanlines />
