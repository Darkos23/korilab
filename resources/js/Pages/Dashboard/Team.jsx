            ...
            {skills.map((sk,i) => (
                <div key={i} className="flex gap-2 items-center">
                    ...
                    <input value={sk.category} onChange={e=>update(i,'category',e.target.value)} placeholder="Catégorie" style={{width:100}}
                        className="bg-white/[0.04] border border-[#00a8ff]/15 rounded-lg px-3 py-1.5 text-white text-sm font-mono outline-none focus:border-[#00a8ff]/40 placeholder-white/10" />
                    <input type="number" min={0} max={100} value={sk.level} onChange={e=>update(i,'level',e.target.value)} style={{width:60}}
                        className="bg-white/[0.04] border border-[#00a8ff]/15 rounded-lg px-2 py-1.5 text-white text-sm font-mono outline-none focus:border-[#00a8ff]/40 text-center" />
