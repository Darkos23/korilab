                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
                            ...
                            <div className="col-span-2">
                                ...
                                <textarea name="desc" value={form.desc} onChange={handleChange} rows={3}
                                    className="w-full bg-white/[0.04] border border-white/15 rounded-sm px-3 py-2 text-white text-sm font-mono
                            ...
                            <div>
                                ...
                                <select name="icon" value={form.icon} onChange={handleChange}
                                    className="w-full bg-white/[0.04] border border-white/15 rounded-sm px-3 py-2 text-white text-sm font-mono focus:border-[#00a8ff]/40 outline-none">
