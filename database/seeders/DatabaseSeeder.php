...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Site::create([
            ...
            'hero'                => ['badge' => 'Système Activé — Studio Créatif', 'titleStart' => 'Nous forjons des', 'titleHighlight' => 'expériences', 'titleEnd' => 'légendaires', 'subtitle' => 'Design, développement et stratégie — nous franchissons les portes de la médiocrité pour construire des produits digitaux de haut niveau.', 'cta1' => 'Voir nos projets', 'cta2' => 'Démarrer un projet'],
            'heroStats'           => [['value' => '100%', 'label' => 'Clients satisfaits'], ['value' => '24h', 'label' => 'Temps de réponse'], ['value' => 'Premium', 'label' => 'Qualité'], ['value' => 'Dakar', 'label' => 'Basés à']],
