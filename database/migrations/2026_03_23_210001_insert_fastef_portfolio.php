...
return new class extends Migration
{
    public function up(): void
    {
        DB::table('portfolio')->insert([
            ...
            'image'       => '/portfolio/fastef-dashboard.png',
            'images'      => json_encode([
                '/portfolio/fastef-dashboard.png',
                '/portfolio/fastef-articles.png',
                '/portfolio/fastef-fournisseurs.png',
                '/portfolio/fastef-rapport.png',
            ]),
            'link'        => null,
            'comingSoon'  => false,
            'created_at'  => now(),
